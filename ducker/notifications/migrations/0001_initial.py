...
import duckerise.notifications.validators
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(max_length=64, unique=True, validators=[duckerise.notifications.validators.validate_event_identifier])),
                ...
                ('mediums', models.ManyToManyField(to='duckerise_notifications.Medium')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='notifications', to='duckerise_notifications.notificationevent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('after_event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followup_events', to='duckerise_notifications.notificationevent')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='duckerise_notifications.notificationevent')),
            ],
        ),
    ]
